...
import { fetchFlashcardsWithEvaluations, type Flashcard as FlashcardType } from "@/lib/flashcard-utils"
  ...
  useEffect(() => {
    const loadFlashcards = async () => {
      ...
      try {
        ...
        // Then fetch all flashcards with evaluations for spaced repetition
        const allCards = await fetchFlashcardsWithEvaluations()
