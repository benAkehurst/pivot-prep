...
import { addDemoFlashcard, fetchDemoFlashcards } from "@/lib/demo-utils"
import Link from "next/link"

export default function DemoAddQuestionPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const newCard = await addDemoFlashcard({
        question,
        answer,
  ...
  return (
    <main className="flex min-h-screen flex-col items-center p-4 md:p-24 bg-gradient-to-b from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-950">
      <div className="w-full max-w-2xl">
        ...
        <div className="bg-yellow-100 dark:bg-yellow-900 border border-yellow-300 dark:border-yellow-700 rounded-md p-4 mb-6">
          <p className="text-yellow-800 dark:text-yellow-200 text-center text-sm">
            This is a demo version. Your flashcards will be stored locally in your browser.
          </p>
        </div>
